...
<html lang="es">
	<head>
	   ...
	   <link rel="stylesheet" type="text/css" href="css/misestuidos.css">
	</head>
...
?>
    ...
    <main class="contenedor">    <!-- definimos los contenidos agrupados en la etiqueta <main> -->
...
echo "<section class= 'sectionestu' >";
...
if ($DatosEstudio = mysqli_query($LinkBD, $ScriptSQL )) {
	...
	echo "<table width='700' border='1' class='tablaestu' align='center'>";
    ...
    // -- A continuación renderizamos la plantilla de ESTUDIOS con la informacion de cada registro...
		...
		echo "<table width='800' height:'200' border='1' class='tablaestu' align='center' >";
		echo "<tr >";
		...
		echo "</section>";  // --- aquí finaliza el ciclo while
